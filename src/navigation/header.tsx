    ...
    <header style={theme.header}>
      ...
      <nav style={theme.nav}>
        <Link
          ...
          style={{
            ...theme.link,
            ...theme.linkWithMargin,
            ...(location.pathname === "/" && theme.activeLink),
          }}
        >
          Inicio
        </Link>
        <Link
          ...
          style={{
            ...theme.link,
            ...theme.linkWithMargin,
            ...(location.pathname === "/discover" && theme.activeLink),
          }}
        >
          Descubre
        </Link>
        <Link
          ...
          style={{
            ...theme.link,
            ...theme.linkWithMargin,
            ...(location.pathname === "/reserve" && theme.activeLink),
          }}
        >
          Acerca de
        </Link>
      ...
      <div style={theme.rightIcons}>
        ...
        <IoChatbubbleOutline
          style={{ ...theme.icon, marginLeft: "5px" }}
